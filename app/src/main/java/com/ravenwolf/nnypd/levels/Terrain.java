...
//    public static final int GRASS_EMPTY     = 48;
	...
	public static final int STATUE_WATER = 51;
	public static final int STATUE_WATER_WALL = 52;

	public static final int STATUE_FROG = 53;
	public static final int STATUE_SHAMAN = 54;
	public static final int STATUE_BRUTE = 55;

	public static final int EMPTY_SP2 = 57;
    ...
    static {
		...
		flags[STATUE_WATER]	= flags[STATUE_SP];
		flags[STATUE_WATER_WALL]	= flags[STATUE_SP];
