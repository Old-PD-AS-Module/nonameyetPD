...
import com.ravenwolf.nnypd.levels.traps.AlarmTrap;
...
//        }
    ...
    protected void createItems() {
        ...
        int chestPos = TOP * WIDTH + CENTER_X - 1;
        drop( new SkeletonKey(), chestPos ).type = Heap.Type.LOCKED_CHEST;
        drop( new TomeOfMasterySkill1(), chestPos, true );

        drop( new GoldenKey(), CENTER ).type = Heap.Type.BONES;
