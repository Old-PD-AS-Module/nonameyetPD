...
/*    @Override
    ...
    @Override
    public String statusMessage() { return "toughness"; }

    @Override
    public String playerMessage() { return "Your feel invincible!"; }


    @Override
    public String description() {
        return "Your feel invincible!. Your resistance against physical damage is increased.";
    }*/
    @Override
    public String toString() {
        return "坚韧";
