...
import com.ravenwolf.nnypd.visuals.effects.BannerSprites.Type;
...
import com.ravenwolf.nnypd.visuals.windows.WndClass;
...
//	private Group unlock3;
	...
	public void create() {
		...
		title.y = align( top - ( NoNameYetPixelDungeon.landscape() ? 24 : 8 ) );
		add( title );
...
//		}
	...
	private class ClassShield extends Button {
		...
		public ClassShield( HeroClass cl ) {
			...
			//name.text( cl.title().toUpperCase(Locale.ENGLISH) );
			//name.measure();
			name.text( cl.title() );
			align(name);
...
//            super.createChildren();
//
//            image = Icons.get( NoNameYetPixelDungeon.challenges() > 0 ? Icons.CHALLENGE_ON :Icons.CHALLENGE_OFF );
//            add(image );
//        }
//
//        @Override
...
//                StartScene.this.add( new WndChallenges( NoNameYetPixelDungeon.challenges(), true ) {
//                    public void onBackPressed() {
//                        super.onBackPressed();
//                        image.copy( Icons.get( NoNameYetPixelDungeon.challenges() > 0 ?
...
//    }
    ...
    private class WndDifficulty extends WndOptions {
        ...
        protected ArrayList<Integer> disabled() {
			...
			//disabled.add( Difficulties.EASY);
