...
import com.ravenwolf.nnypd.scenes.TitleScene;
...
public class NoNameYetPixelDungeon extends Game {
	...
	public NoNameYetPixelDungeon() {
        ...
        com.watabou.utils.Bundle.addAlias(
                com.ravenwolf.nnypd.items.wands.CharmOfThorns.class,
                "com.ravenwolf.nnypd.items.wands.WandOfThornvines" );

		com.watabou.utils.Bundle.addAlias(
				com.ravenwolf.nnypd.items.wands.CharmOfSanctuary.class,
				"com.ravenwolf.nnypd.items.wands.WandOfSanctuary" );

		com.watabou.utils.Bundle.addAlias(
				com.ravenwolf.nnypd.items.wands.CharmOfBlink.class,
				"com.ravenwolf.nnypd.items.wands.WandOfBlink" );

		com.watabou.utils.Bundle.addAlias(
				com.ravenwolf.nnypd.items.wands.CharmOfDomination.class,
				"com.ravenwolf.nnypd.items.wands.WandOfDomination" );

		com.watabou.utils.Bundle.addAlias(
				com.ravenwolf.nnypd.items.wands.CharmOfDecay.class,
				"com.ravenwolf.nnypd.items.wands.WandOfDecay" );

		com.watabou.utils.Bundle.addAlias(
				com.ravenwolf.nnypd.items.wands.CharmOfShadows.class,
				"com.ravenwolf.nnypd.items.wands.WandOfEntanglement" );

		com.watabou.utils.Bundle.addAlias(
				LightCrossbow.class,
				"com.ravenwolf.nnypd.items.weapons.ranged.LigthCrossbow" );
	...
	public static void autoThrow( boolean value ) {
		Preferences.INSTANCE.put( Preferences.KEY_AUTO_THROW, value );
	}

	public static boolean autoThrow() {
		return Preferences.INSTANCE.getBoolean( Preferences.KEY_AUTO_THROW, true );
	}
...
//
//    public static void buttons( boolean power ) {
//        Preferences.INSTANCE.put( Preferences.KEY_BUTTONS, power );
//    }
//
