...
import com.ravenwolf.nnypd.items.weapons.melee.MeleeWeaponHeavyOH;
...
//            curUser.sprite.emitter().start( Speck.factory(Speck.CHANGE), 0.1f, 5 );
    ...
    public static boolean transmute( Item item ) {
        ...
        if(item instanceof ThrowingWeapon) {
            ...
            if( curUser.belongings.ranged == item ) {

                curUser.belongings.ranged = (Weapon)newItem;
    ...
    private static Weapon changeWeapon( Weapon w ) {
        ...
        Weapon n;
        do {
            n = (Weapon) Generator.random(Generator.Category.WEAPON, true);
    ...
    private static Armour changeArmour( Armour a ) {
        ...
        Armour n = (Armour) Generator.random(Generator.Category.ARMOR, true);
        ...
        if (a instanceof Shield) {
            while (n == null || n.getClass() == a.getClass() || !( n instanceof Shield ) || n.tier+1<a.tier || n.tier>a.tier+1) {
                n = (Armour) Generator.random(Generator.Category.ARMOR, true);
            }
