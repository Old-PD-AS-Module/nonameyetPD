...
public abstract class MeleeWeaponHeavyOH extends MeleeWeapon {
    ...
    private static final String TXT_EQUIP_MESSAGE =
            "这是一把重型单手武器，你可以选择把它装备到副手武器，并且增加额外的力量需求，还可能会降低你的战斗效率，" +
                    "你想把它当做主手武器还是副手武器？";
    ...
    public int strShown( boolean identified ) {
        ...
        return super.strShown( identified ) + (this == Dungeon.hero.belongings.weap2 ? tier :0);
    }
/*
    @Override
    public boolean incompatibleWith( EquipableItem item ) {
        if (this == Dungeon.hero.belongings.weap1)
            return false;

        return this == Dungeon.hero.belongings.weap2 && (item instanceof MeleeWeaponHeavyTH ||item instanceof MeleeWeaponLightTH);
...
//            if( QuickSlot.quickslot1.power == this && hero.belongings.weap2 != null )
//                QuickSlot.quickslot1.power = hero.belongings.weap2.stackable ? hero.belongings.weap2.getClass() : hero.belongings.weap2 ;
//
//            if( QuickSlot.quickslot2.power == this && hero.belongings.weap2 != null )
//                QuickSlot.quickslot2.power = hero.belongings.weap2.stackable ? hero.belongings.weap2.getClass() : hero.belongings.weap2 ;
