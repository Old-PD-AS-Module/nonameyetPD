...
public class Caustic extends Weapon.Enchantment {
    ...
    protected String desc_p() {
        return "攻击时会使敌人被一层腐蚀液体覆盖";
    }

    @Override
    protected String desc_n() {
        return "攻击时会使自己被一层腐蚀液体覆盖";
    }
    ...
    protected boolean proc_p( Char attacker, Char defender, int damage ) {
        ...
        BuffActive.addFromDamage( defender, Corrosion.class, damage );
        return true;
    ...
    protected boolean proc_n( Char attacker, Char defender, int damage ) {
        ...
        BuffActive.addFromDamage( attacker, Corrosion.class, damage*2/3 );
        return true;
