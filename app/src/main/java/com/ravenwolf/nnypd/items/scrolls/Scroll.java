...
//		ScrollOfMirrorImage.class,
	...
	private static final String[] runes = 
		{"KAUNAN", "SOWILO", "LAGUZ", "YNGVI", "GYFU", "RAIDO", "ISAZ", "MANNAZ", "NAUDIZ", "BERKANAN", "ODAL", "TIWAZ"/*, "DAGAS"*/};
...
//		defaultAction = AC_READ;
	...
	public void activateScroll(Scroll scroll,  Hero hero) {
		curUser = hero;
		curItem =scroll;
		doRead();
	}
