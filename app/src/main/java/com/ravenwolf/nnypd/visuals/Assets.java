 ...
 */
package com.ravenwolf.nnypd.visuals;

public class Assets {

	/* 0.5 */
	public static final String ICEBLOCK = "mob_iceblock.png";
	...
	public static final String WARRIOR	= "pc_warrior.png";
	public static final String MAGE		= "pc_mage.png";
	public static final String ROGUE 	= "pc_rogue.png";
	public static final String HUNTRESS = "pc_huntress.png";
	...
	public static final String THORNSPITTER		= "mob_thornspitter.png";
	public static final String JADE_WARDEN 		= "mob_jade_warden.png";
	public static final String ARCANE_ORB		= "mob_arcane_orb.png";
	public static final String SPIRIT_WOLF		= "mob_spirit_wolf.png";

    public static final String RAT		= "mob_rat.png";
    public static final String THIEF	= "mob_thief.png";
    public static final String GNOLL	= "mob_gnoll.png";
    public static final String CRAB		= "mob_crab.png";

    public static final String SWARM	= "mob_swarm.png";
    public static final String SKELETON	= "mob_skeleton.png";
    public static final String SHAMAN	= "mob_shaman.png";
    public static final String SPINNER	= "mob_spider.png";

    public static final String BAT		= "mob_bat.png";
    public static final String BRUTE	= "mob_brute.png";
    public static final String SCORPION = "mob_scorpio.png";
    public static final String EVILEYE  = "mob_evileye.png";

    public static final String MONK		= "mob_monk.png";
    public static final String ELEMENTAL= "mob_elemental.png";
    public static final String WARLOCK	= "mob_warlock.png";
    public static final String GOLEM	= "mob_golem.png";

    public static final String IMP		= "mob_imp.png";
    public static final String SUCCUBUS	= "mob_succubus.png";
    public static final String FIEND    = "mob_fiend.png";
	public static final String DEATHKNIGHT = "mob_deathknight.png";

    public static final String PIRANHA	= "mob_piranha.png";
    public static final String STATUE	= "mob_statue.png";
    public static final String WRAITH	= "mob_wraith.png";
    public static final String MIMIC	= "mob_mimic.png";

    public static final String LARVA	= "mob_larva.png";
    public static final String UNDEAD	= "mob_undead.png";
    public static final String ROTTING	= "mob_fist_rotting.png";
    public static final String BURNING	= "mob_fist_burning.png";

    public static final String GOO		= "mob_boss_goo.png";
    public static final String TENGU	= "mob_boss_tengu.png";
    public static final String DM300	= "mob_boss_dm300.png";
    public static final String KING		= "mob_boss_king.png";
    public static final String YOG		= "mob_boss_yog.png";

	public static final String MEDUSA	= "mob_boss_medusa.png";
	public static final String NECROMANCER	= "mob_boss_necromancer.png";
	public static final String ABOMINATION	= "mob_boss_abomination.png";
	public static final String FROG		= "mob_frog.png";
	public static final String ROBOT	= "mob_robot.png";
	public static final String DEMON	= "mob_demon.png";
	public static final String PLAGUE_DOCTOR	= "mob_plague_doctor.png";
	public static final String HAUNTED_ARMOR	= "mob_haunted_armor.png";
	public static final String GUARD	= "mob_prison_keeper.png";

    public static final String GHOST	= "npc_ghost.png";
    public static final String MAKER	= "npc_wandmaker.png";
    public static final String TROLL	= "npc_blacksmith.png";
    public static final String NPC_IMP  = "npc_imp.png";

    public static final String KEEPER_HUMAN = "npc_shop_human.png";
    public static final String KEEPER_GHOST = "npc_shop_ghost.png";
    public static final String KEEPER_TROLL = "npc_shop_troll.png";
    public static final String KEEPER_DWARF = "npc_shop_dwarf.png";
	public static final String KEEPER_ROBOT  = "npc_shop_robot.png";
	public static final String NPC_PLAGUE_DOC = "npc_plague_doc.png";
	public static final String NPC_ENCHANTRESS = "npc_enchantress.png";
	public static final String NPC_VENDING_MACHINE = "npc_vending_machine.png";

	public static final String HAZ_PIRANHA	= "hazard_piranha.png";
	public static final String HAZ_RUNE		= "hazard_rune.png";
	...
	public static final String BUFFS_SMALL	= "buffs_small.png";
