...
public class ShopkeeperRobotSprite extends MobSprite {

	private PixelParticle coin;

	public ShopkeeperRobotSprite() {
		super();
		
		texture( Assets.KEEPER_ROBOT);
		TextureFilm film = new TextureFilm( texture, 16, 12 );
