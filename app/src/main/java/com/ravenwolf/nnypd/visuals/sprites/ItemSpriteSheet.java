...
public class ItemSpriteSheet {
    ...
    public static final int GREAT_AXE		    = 32;
    ...
    public static final int ARROW	    	    = 17;//58;
    ...
    public static final int POTION_PINK     = 7;
    public static final int POTION_EMERALD	= 8;
    public static final int POTION_LIME		= 9;
    public static final int POTION_EMPTY	= 10;
    public static final int POTION_UNKNOWN	= 11;
    ...
    public static final int WAND_BLINK          = 131;
    public static final int WAND_WEB            = 130;

    // Charms

    public static final int CHARM_SHADOWS       = 204;
    public static final int CHARM_BLINK         = 205;
    public static final int CHARM_BONE          = 206;
    public static final int CHARM_THORN         = 207;
    public static final int CHARM_BLAST         = 208;
    public static final int CHARM_DOMINATION    = 209;
    public static final int CHARM_JADE          = 210;
    public static final int CHARM_BLESS         = 211;
    ...
    public static final int HERB_STORMVINE	    = 126;
    public static final int HERB_FADELEAF	    = 127;
    public static final int HERB_WHIRLVINE      = 128;
    public static final int HERB_WYRMFLOWER     = 129;
    ...
    public static final int QUIVER		        = 138;
    public static final int BALDRIC		        = 139;
    ...
    public static final int INVISIBLE           = 143;
    public static final int SPECTRAL_BLADE      = 140;
    ...
    public static final int TOME    		    = 184;
    public static final int TOME_SPELL  		= 185;
    public static final int TOME_SPELL_II  		= 186;

    public static final int THROWING_SPEAR    	= 18;
    public static final int THROWING_HAMMER	    = 19;
    public static final int MOON_GLAIVE	        = 20;

    public static final int BLUNTED_ARROW 		= 6;

    public static final int LONG_BOW           	= 21;
    public static final int COMPOSITE_BOW	    = 22;
    public static final int HEAVY_CROSSBOW	    = 23;

    public static final int SHIELD_LARGE		= 188;
    public static final int SHIELD_ARCANE       = 189;
    public static final int SHIELD_WAR		    = 190;
    public static final int SHIELD_GREAT        = 191;

    public static final int KATAR               = 192;
    public static final int ASSASSIN_BLADE    	= 193;
    public static final int HAND_AXE    	    = 194;
    public static final int LONG_STAFF    	    = 195;
    public static final int SCIMITAR    	    = 196;
    public static final int FLAIL   	        = 197;
    public static final int DOUBLE_BLADE   	    = 198;
    public static final int OBSIDIAN_BLADE   	= 199;
    public static final int BATTLE_AXE		    = 200;
    public static final int MAGE_STAFF          = 201;
    public static final int KATANA              = 202;
    public static final int KOPESH              = 203;
}
